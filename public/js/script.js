...
//    range fonts
    $('#range-value').html($('#input-range').attr('value') + 'px');
    $('#input-range').on('input', function () {
        $('#range-value').html(this.value + "px");
        $('#sortable p,.red_left_side li, #sortable span').css("font-size", this.value + "px");
    });
//
    $('#range-value1').html($('#input-range1').attr('value') + 'px');
    $('#input-range1').on('input', function () {
        $('#range-value1').html(this.value + "px");
        $("#sortable h5").css("font-size", this.value + "px");
    });
// //
    $('#range-value2').html($('#input-range2').attr('value') + 'px');
    $('#input-range2').on('input', function () {
        $('#range-value2').html(this.value + "px");
        $("#sortable > li,#sortable .example4-row").css("margin-bottom", this.value + "px")
    });
// //
    $('#range-value3').html($('#input-range3').attr('value') + 'px');
    $('#input-range3').on('input', function () {
        $('#range-value3').html(this.value + "px");
        $("#sortable p").css("margin", this.value + "px 0px")
    });
// //
    $('#range-value4').html($('#input-range4').attr('value') + 'px');
    $('#input-range4').on('input', function () {
        $('#range-value4').html(this.value + "px");
        $("#sortable p").css("line-height", this.value + "px")
    });
// //
    $('#range-value5').html($('#input-range5').attr('value') + 'px');
...
// //
    $('#range-value6').html($('#input-range6').attr('value') + 'px');
...
// //
    $('#range-value7').html($('#input-range7').attr('value') + 'px');
...
// //
    ...
    $('#input-range8').on('input', function () {
        ...
        $("#sortable p,#sortable li,#sortable span").css("font-weight", this.value)
    });
//
    $("#font_famly").on("change", function () {
        // $("#sortable").css("font-family", this.value)
        $("#sortable").css("font-family", $(":selected").text());
    });
